...
function TelescopeApi.edit_neovim()
...
function TelescopeApi.live_grep(opts)
	require("telescope.builtin").live_grep(vim.tbl_deep_extend("force", opts, {
		-- shorten_path = true,
		previewer = false,
		fzf_separator = "|>",
	}))
...
function TelescopeApi.oldfiles_frecency()
...
return setmetatable({}, {
	__index = function(_, k)
		...
		local has_custom, custom = pcall(require, string.format("lvm.modules.telescope.custom.%s", k))
